...
from forgotpasswordHr import forgot
...
class Login:
    def __init__(self,window):
        ...
        mainframe=Image.open(r"D:\Vicky_All_Program\python\Hotel&RestorantManagementSystem\hotelloginimg.jpg")
        ...
        Logintitle=Label(login,text="Login Page",font=("Bodoni MT Black",20,"bold"),bg="#132542",fg="gold")
    ...
    def Login(self):
        ...
        query="select COUNT(*) from loginregisterhr WHERE Username='{}' AND Password='{}'".format(self.usernamefield.get(),self.passwordfield.get())
