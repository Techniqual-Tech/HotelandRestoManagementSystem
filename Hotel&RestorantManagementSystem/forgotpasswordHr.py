...
class forgot:
    ...
    def forgot(self):
        ...
        query="select COUNT(*) from loginregisterhr WHERE Username='{}' AND BestFriend='{}'".format(self.usernamefield.get(),self.bestfriendfield.get())
                    ...
                    if numbers==8 or strings==8:
                        ...
                        if upper==a or lower==a:
                            ...
                            if  self.passwordfield.get()== self.Cpasswordfield.get():
                                querys="UPDATE loginregisterhr SET Password='{}',ConfirmPassword='{}' WHERE Username='{}' AND BestFriend='{}'".format(self.passwordfield.get(),self.Cpasswordfield.get(),self.usernamefield.get(),self.bestfriendfield.get())
